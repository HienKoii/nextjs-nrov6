...
import { getPasswordById, updatePasswordById } from "@/services/accountService";
...
export async function POST(req) {
  ...
  try {
    ...
    const rows = await getPasswordById(decoded.id);
    ...
    updatePasswordById(newPassword, decoded.id);
